...
# def main():
#     print("🔹 Generating synthetic data (50 samples, 20 features, 5 informative)...")
#     X, y = make_classification(n_samples=50, n_features=20, n_informative=5, n_redundant=2, random_state=42)

#     print("🔹 Running NSGA-II (debug demo)...")
...
#     print("\n✅ Optimization done! Top 5 solutions:\n")
#     if not sols:
...
# main.py
# --------------------------------------------
# تنفيذ خوارزمية NSGA-II + المقارنة بالطرق التقليدية
# --------------------------------------------
# ==============================================
# main.py
# تشغيل NSGA-II + المقارنة بالطرق التقليدية
# ==============================================
# src/main.py
import pandas as pd
from ga_nsga2 import run_nsga2  
